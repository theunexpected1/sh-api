...
router.get("/:id", propertiesCrump, async (req, res) => {
  ...
  res.render("admin/pricing/list", data);
});
...
router.get("/edit/:id", async (req, res) => {
  ...
  res.render("admin/pricing/innerlist", data);
});
...
router.get("/edit/price/:id", async (req, res) => {
  ...
  res.render("admin/pricing/edit", data);
});
...
router.get("/new/:id", async (req, res) => {
  ...
  res.render("admin/pricing/new", data);
});
...
router.get("/delete/:id", async (req, res) => {
  ...
  res.redirect("/admin/pricing/edit/" + room_id);
});
