...
router.get("/", paginate.middleware(10, 50), async (req, res) => {
  ...
  res.render("admin/properties/list", data);
});
...
router.get("/new", propertiesCrump, async (req, res) => {
  ...
  res.render("admin/properties/new", data);
});
...
router.get("/edit/:id", propertiesCrump, async (req, res) => {
  ...
  res.render("admin/properties/edit", data);
});
      ...
      if (property) {
        ...
        if (!has_active_bookings) {
          ...
          if (hoteladmin) {
            ...
            await hoteladmin.save();
            return res.redirect("/admin/hoteladmins/" + hoteladmin._id);
          }
        }else{
...
router.get("/view/:id", async (req, res) => {
  ...
  // return res.json(property);
  res.render("admin/properties/view.ejs", data);
});
