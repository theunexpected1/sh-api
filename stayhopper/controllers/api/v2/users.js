...
router.get("/bookings", jwtMiddleware.userAuthenticationRequired, async (req, res) => {
...
router.post('/change-password', jwtMiddleware.userAuthenticationRequired, async(req,res)=>{
